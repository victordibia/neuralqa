...
export function sampleConfig() {
    return { "header": { "appdescription": "Question Answering on Large Datasets", "appname": "NeuralQA" }, "queryview": { "intro": { "disclaimer": " .. ", "subtitle": "NeuralQA is an interactive tool for question answering (passage retrieval + document reading). You can manually provide a passage or select a search index from (e.g. case.law ) dataset under the QA configuration settings below. To begin, type in a question query below.", "title": "NeuralQA: Question Answering on Large Datasets" }, "options": { "expander": { "options": [{ "name": "None", "value": "none" }, { "name": "Synonyms", "value": "synonyms" }, { "name": "Masked LM", "value": "maskedlm" }], "selected": "None", "title": "Expander" }, "highlightspan": { "options": [{ "name": 150, "value": 150 }, { "name": 250, "value": 250 }, { "name": 350, "value": 350 }, { "name": 450, "value": 450 }, { "name": 650, "value": 650 }], "selected": 250, "title": "IR Highlight Span" }, "maxpassages": { "options": [{ "name": 5, "value": 5 }, { "name": 10, "value": 10 }, { "name": 15, "value": 15 }], "selected": 5, "title": "Passages" }, "reader": { "options": [{ "name": "DistilBERT SQUAD2", "type": "distilbert", "value": "twmkn9/distilbert-base-uncased-squad2" }], "selected": "twmkn9/distilbert-base-uncased-squad2", "title": "Reader" }, "relsnip": { "options": [{ "name": true, "value": true }, { "name": false, "value": false }], "selected": true, "title": "Relsnip" }, "retriever": { "options": [{ "name": "Manual", "value": "manual" }, { "host": "localhost", "name": "Case Law", "password": "None", "port": 9200, "type": "elasticsearch", "username": "None", "value": "cases" }], "readtopn": 0, "selected": "manual", "title": "Retriever" }, "stride": { "options": [{ "name": 0, "value": 0 }, { "name": 50, "value": 50 }, { "name": 100, "value": 100 }, { "name": 200, "value": 200 }], "selected": 0, "title": "Token Stride" } }, "views": { "advanced": true, "allanswers": true, "expander": false, "explanations": true, "intro": true, "passages": true, "samples": true } } }
}
